...
Given an integer array nums and an integer k, print the number of non-empty subarrays
...
import java.util.*;
public class arr18{
    public static int Subarraydiv(int n , int arr[], int k){
        int count =0;
        for(int i=0;i<n;i++){
            int sum=0;
            for(int j =i;j<n;j++){
    ...
    public static void main(String[] args) {
        try(Scanner sc = new Scanner(System.in)){
            ...
            System.out.print(Subarraydiv(n, arr, k));
        }
    }
}